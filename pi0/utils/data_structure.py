...
class Shower:
    ...
    '''
    def __init__(self, start=-np.ones(3), direction=-np.ones(3), voxels=[], energy=-1., pid=-1, L_e=-1., L_p=-1., fiducial=True):
        self.start      = start
    ...
    def __str__(self):
        ...
        Electron L : {}
        Fiducial   : {}
        """.format(self.pid, *self.start, *self.direction, len(self.voxels), self.energy, self.L_p, self.L_e, self.fiducial)
